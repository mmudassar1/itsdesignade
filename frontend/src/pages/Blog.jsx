    ...
    return (
        <div className="bg-white min-h-screen pt-24 sm:pt-32 md:pt-40">
            ...
            <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 mb-16 sm:mb-20">
                <Reveal>
                    <h1 className="text-[12vw] sm:text-[10vw] font-black uppercase leading-[0.8] mb-6 sm:mb-8 font-display">INSIGHTS</h1>
                </Reveal>
                <Reveal delay={0.2}>
            ...
            <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 mb-20 sm:mb-24">
                <Reveal delay={0.3}>
                    <Link to={`/blog/${articles[0].slug}`} className="group relative w-full h-[400px] sm:h-[500px] md:h-[600px] rounded-3xl overflow-hidden cursor-pointer block">
                        <img
                        ...
                        <div className="absolute inset-0 bg-black/40 hover:bg-black/30 transition-colors duration-300 flex flex-col justify-end p-6 sm:p-10 md:p-14">
                            ...
                            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold font-display text-white mb-4 leading-tight">
                                Designing for the <br /> Next Generation.
                            </h2>
                            <div className="flex items-center text-white font-bold uppercase tracking-wider text-sm sm:text-base group-hover:text-primary transition-colors">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
                    {articles.map((article, index) => (
                        <Reveal key={index} delay={index * 0.05}>
                            <Link to={`/blog/${article.slug}`} className="group cursor-pointer block">
                                ...
                                <h3 className="text-2xl font-bold mb-3 leading-tight font-display group-hover:text-primary transition-colors">{article.title}</h3>
                                <p className="text-gray-500 leading-relaxed mb-4">{article.desc}</p>
                                <span className="inline-flex items-center text-sm font-bold uppercase tracking-widest border-b border-black pb-0.5 group-hover:border-primary group-hover:text-primary transition-colors">
                                    Read Story <ArrowUpRight size={14} className="ml-1 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
                                </span>
                            </Link>
                        </Reveal>
                    ))}
